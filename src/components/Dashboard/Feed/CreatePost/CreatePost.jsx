        ...
        <form onSubmit={handleSubmit}>
            <div className='create-post-wrapper'>
                <div className='create-post-form'>
                    ...
                    <textarea name="caption" id="caption" cols={30}
                              rows={2} placeholder='Want to share something?'
                ...
                <div className="create-post-action-bar">
                    <div>
                        <div className="input-element">
                            <label htmlFor="image"><AttachmentRoundedIcon/></label>
                            <input type='file' alt='hello' id='image'
